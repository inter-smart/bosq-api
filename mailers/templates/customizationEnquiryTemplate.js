const customizationEnquiryTemplate = (data, iconsHtml = "") => {
  ...
  const { first_name, last_name, company_name, state_label, message, option_label } = data;
                ...
                <tr>
                    <td style="padding:27px 40px 20px;">
                        <h2 style="font-size:22px; color:#282828; font-weight:600; margin:0; text-align:center;">
                            Thank You for Your Customization Enquiry
                        </h2>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:0 30px;">
                        ...
                        <p style="font-size:16px; color:#282828; width:95%; margin:0 auto 24px; line-height:25px; text-align:center;">
                            Thank you for reaching out to Bosq regarding your customization requirements.
                            We have received your enquiry and our design specialists are reviewing your request
                            to provide tailored recommendations and solutions.
                        </p>
                    </td>
                </tr>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="font-size:14px; color:#444444; margin:0 0 12px;">
                                        <strong>Requirement Type:</strong> ${option_label}
                                    </p>
                                    ...
                                    ${
                                      state_label
                                        ? `
                                    <p style="font-size:14px; color:#444444; margin:0 0 12px;">
                                        <strong>Location / State:</strong> ${state_label}
                                    </p>
                                    `
                                        : ""
                                    }
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style="font-size:14px; color:#cccccc; line-height:24px; margin:0 0 20px;">
                                        Our Bosq customization specialist will contact you within 24 hours
                                        with design recommendations, pricing options, material selections,
                                        and project-specific solutions tailored to your requirements.
                                    </p>
...
module.exports = customizationEnquiryTemplate;
