...
class AuthCmsController {
  ...
  static async update(req, res) {
    ...
    try {
      ...
      const fileFields = ["signup_media_desktop_path", "banner_media_mobile_path"];
...
module.exports = AuthCmsController;
