...
const { validateId, validationRequestPost } = require("../../../request/cms/customization/customizationFeaturesRequest.js");

const DataModel = models.CustomizationFeatures;
  ...
  static async index(req, res) {
    try {
      const result = await paginate(DataModel, req, {
        ...
        searchFields: ["title", "title_ar", "description", "description_ar"],
      });
