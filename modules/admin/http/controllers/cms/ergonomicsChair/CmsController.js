...
const { validationRequestPost } = require("../../../request/cms/ergonomicsChair/cmsRequest.js");
const { handleFileUploadUpdate } = require("../../../../http/middleware/multerMiddleware");



const DataModel = models.ErgonimicsCms;


class ErgonomicsChairCmsController {
...
module.exports = ErgonomicsChairCmsController;
