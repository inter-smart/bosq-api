...
const { validateId, validationRequestPost } = require("../../request/projects/specialisedSectionsRequest.js");

const DataModel = models.SpecialisedAreas;
...
module.exports = SpecialisedSectionController;
