...
const { validationRequestPost, validateId } = require("../../request/siteSettings/paymentMethodsRequest.js");
...
const DataModel = models.PaymentMethods;
    ...
    static async index(req, res) {
        try {
            const result = await paginate(DataModel, req, {
                ...
                searchFields: ["icon_alt", "icon_alt_ar"],
            });
