...
exports.validationRequestPost = [
  ...
  body("details_ar")
    .optional()
    .isString()
    .withMessage("Details (Arabic) must be a string"),

  /* ---------- DETAILS POINTS ---------- */
  body("details_points")
    .optional()
    .isString()
    .withMessage("Details points must be a string"),
  body("details_points_ar")
    .optional()
    .isString()
    .withMessage("Details points (Arabic) must be a string"),
  ...
  body("additional_details_ar")
    .optional()
    .isString()
    .withMessage("Additional details (Arabic) must be a string"),
