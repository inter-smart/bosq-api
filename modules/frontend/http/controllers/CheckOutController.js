...
class CheckOutController {
  ...
  static async applyCoupon(req, res) {
    try {
      ...
      const cart_type = req.body?.cart_type || "cart";
      ...
      const result = await CheckOutService.applyCoupon(userId, coupon_code.trim().toUpperCase(), cart_type);
  ...
  static async removeCoupon(req, res) {
    try {
      ...
      const result = await CheckOutService.removeCoupon(userId, sessionId, cart_type);
