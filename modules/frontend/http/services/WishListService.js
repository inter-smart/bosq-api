...
const { generateQueryParams } = require("../traits/dataManipulations/product/product.js");
...
class WishListService {
  ...
  static async getWishlist(req) {
    try {
      ...
      const { rows: wishlistItems, count: totalCount } = await DataModel.findAndCountAll({
